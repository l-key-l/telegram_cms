...
urlpatterns = [
    ...
    path("master/tasks", master_views.scheduled_tasks, name="master-tasks"),
    path("master/tasks/<int:pk>/stop", master_views.scheduled_task_stop, name="master-task-stop"),
    ...
    path("user/tasks", user_views.scheduled_tasks, name="user-tasks"),
    path("user/tasks/<int:pk>/stop", user_views.scheduled_task_stop, name="user-task-stop"),
